...
// SmartPrefetchBuffer is a smart buffer to store and read data from a file.
class SmartPrefetchBuffer {
 public:
  ...
  // A user can construct a SmartPrefetchBuffer without any arguments, but use
  ...
  SmartPrefetchBuffer(
      ...
      SmartPrefetchBufferUsage usage = SmartPrefetchBufferUsage::kUnknown)
      : curr_(0),
 ...
 private:
  ...
  // SmartPrefetchBuffer object won't be created from Iterator flow if
  ...
  SmartPrefetchBufferUsage usage_;
};
}  // namespace ROCKSDB_NAMESPACE
